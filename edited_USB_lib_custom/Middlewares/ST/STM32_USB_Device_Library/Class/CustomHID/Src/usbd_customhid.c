...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x03,                                               /* bNumInterfaces: 3 interface (keyboard, mouse, media keys)*/
  ...
  // Endpoint IN Descriptor for Keyboard
  /* 27 */
  ...
  // Endpoint  OUT Descriptor for Keyboard
  0x07,                                               /* bLength: Endpoint Descriptor size */
  USB_DESC_TYPE_ENDPOINT,                             /* bDescriptorType: */
  ...
  // Interface Descriptor for Mouse
  0x09,        // bLength: Interface Descriptor size
  ...
  // Endpoint IN Descriptor for Mouse
  0x07,        // bLength: Endpoint Descriptor size
  USB_DESC_TYPE_ENDPOINT, // bDescriptorType: Endpoint
  CUSTOM_MOUSE_EPIN_ADDR, // bEndpointAddress: Endpoint Address (IN) ??? ezeket az addresseket meg meg kell nezni, mert nem leteznek
  0x03,        // bmAttributes: Interrupt endpoint
  LOBYTE(CUSTOM_MOUSE_EPIN_SIZE), // wMaxPacketSize
  HIBYTE(CUSTOM_MOUSE_EPIN_SIZE),
  CUSTOM_HID_FS_BINTERVAL, // bInterval (Polling interval)

  // Interface Descriptor for Media Keys
  0x09,                    // bLength: Interface Descriptor size
  USB_DESC_TYPE_INTERFACE, // bDescriptorType: Interface
  0x02,                    // bInterfaceNumber: Interface number 2 (following keyboard and mouse)
  0x00,                    // bAlternateSetting: Alternate setting
  0x01,                    // bNumEndpoints: 1 endpoint (IN)
  0x03,                    // bInterfaceClass: HID
  0x00,                    // bInterfaceSubClass: No subclass
  0x00,                    // nInterfaceProtocol: No specific protocol
  0x00,                    // iInterface: Index of string descriptor

  // HID Descriptor for Media Keys
  0x09, 0x21,              // bLength, bDescriptorType (HID)
  0x11, 0x01,              // bcdHID: HID Class Spec release number
  0x00,                    // bCountryCode: Hardware target country
  0x01,                    // bNumDescriptors: Number of HID class descriptors to follow
  0x22,                    // bDescriptorType: Report Descriptor
  LOBYTE(USBD_CUSTOM_HID_REPORT_DESC_SIZE), // wDescriptorLength: Total length of the Report descriptor
  HIBYTE(USBD_CUSTOM_HID_REPORT_DESC_SIZE),

  // Endpoint IN Descriptor for Media Keys
  0x07,                    // bLength: Endpoint Descriptor size
  USB_DESC_TYPE_ENDPOINT,  // bDescriptorType: Endpoint
  CUSTOM_MEDIA_EPIN_ADDR,  // bEndpointAddress: Endpoint Address (IN)
  0x03,                    // bmAttributes: Interrupt endpoint
  LOBYTE(CUSTOM_MEDIA_EPIN_SIZE), // wMaxPacketSize: Maximum packet size
  HIBYTE(CUSTOM_MEDIA_EPIN_SIZE),
  CUSTOM_HID_FS_BINTERVAL  // bInterval: Polling interval
};
#endif /* USE_USBD_COMPOSITE  */
